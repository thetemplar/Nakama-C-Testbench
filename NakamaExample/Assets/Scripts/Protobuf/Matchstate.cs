...
namespace NakamaMinimalGame.PublicMatchState
{
    ...
    public static partial class MatchstateReflection
    {
        ...
        static MatchstateReflection()
        {
            byte[] descriptorData = global::System.Convert.FromBase64String(
                string.Concat(
                  "ChBtYXRjaHN0YXRlLnByb3RvEgRtYWluGg9jaGFyYWN0ZXIucHJvdG8i1hYK",
                  ...
                  "aWVkEAJCGAoWc291cmNlX3NwZWxsX2VmZmVjdF9pZEIGCgR0eXBlGv4CCgxJ",
                  ...
                  "GAsgAygLMhsubWFpbi5QdWJsaWNNYXRjaFN0YXRlLkF1cmEiGwoEVHlwZRIK",
                  "CgZQbGF5ZXIQABIHCgNOUEMQARpcCgRBdXJhEhcKD2NyZWF0ZWRfYXRfdGlj",
                  "axgBIAEoAxIPCgdjcmVhdG9yGAIgASgJEhEKCWVmZmVjdF9pZBgDIAEoAxIX",
                  "Cg9hdXJhX3RpY2tfY291bnQYBCABKAUauQEKClByb2plY3RpbGUSCgoCaWQY",
                  "ASABKAkSEAoIc3BlbGxfaWQYAiABKAMSFwoPY3JlYXRlZF9hdF90aWNrGAMg",
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::NakamaMinimalGame.PublicMatchState.PublicMatchState.Types.Interactable), global::NakamaMinimalGame.PublicMatchState.PublicMatchState.Types.Interactable.Parser, new[]{ "Id", "Type", "CharacterId", "LastProcessedClientTick", "Invulnerable", "Character", "Position", "Rotation", "GlobalCooldown", "Target", "Auras" }, null, new[]{ typeof(global::NakamaMinimalGame.PublicMatchState.PublicMatchState.Types.Interactable.Types.Type) }, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::NakamaMinimalGame.PublicMatchState.Client_SelectCharacter), global::NakamaMinimalGame.PublicMatchState.Client_SelectCharacter.Parser, new[]{ "Class" }, null, null, null)
                }));
        }
        #endregion
                ...
                public static partial class Types
                {
                    ...
                    public sealed partial class CombatLogEntry_Damage : pb::IMessage<CombatLogEntry_Damage>
                    {
                        ...
                        public override int GetHashCode()
                        {
                            ...
                            if (Resisted != 0F) hash ^= Resisted.GetHashCode();
                            if (Blocked != 0F) hash ^= Blocked.GetHashCode();
                            if (Absorbed != 0F) hash ^= Absorbed.GetHashCode();
                            if (Critical != 0F) hash ^= Critical.GetHashCode();
                            if (Overkill != 0F) hash ^= Overkill.GetHashCode();
                            return hash;
                        }
                    ...
                    public sealed partial class CombatLogEntry_Heal : pb::IMessage<CombatLogEntry_Heal>
                    {
                        ...
                        public override int GetHashCode()
                        {
                            ...
                            if (Absorbed != 0F) hash ^= Absorbed.GetHashCode();
                            if (Critical != 0F) hash ^= Critical.GetHashCode();
                            if (Overheal != 0F) hash ^= Overheal.GetHashCode();
                            return hash;
                        }
    ...
    public sealed partial class Client_SelectCharacter : pb::IMessage<Client_SelectCharacter>
    {
        ...
        public static pbr::MessageDescriptor Descriptor
        {
            get { return global::NakamaMinimalGame.PublicMatchState.MatchstateReflection.Descriptor.MessageTypes[5]; }
        }
